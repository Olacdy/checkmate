...
const sheetVariants = cva(
  'fixed z-50 gap-4 dark:bg-off-white p-6 shadow-lg transition ease-in-out data-[state=open]:animate-in data-[state=closed]:animate-out data-[state=closed]:duration-300 data-[state=open]:duration-500 bg-oxford-blue-dark',
  {
    variants: {
      side: {
