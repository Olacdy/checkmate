...
export const Icons = {
  ...
  githubAuth: ({ ...props }: LucideProps) => (
    <svg
      ...
      fill='current'
      className={cn('', props.className)}>
      <path d='M35 6.563C19.295 6.563 6.563 19.295 6.563 35c0 13.428 9.31 24.675 21.826 27.657a28.849 28.849 0 0 1 -1.92 -0.524V55.617s-1.066 0.355 -2.488 0.355c-3.978 0 -5.631 -3.549 -6.043 -5.332 -0.25 -1.086 -0.905 -2.115 -1.607 -2.744 -0.839 -0.748 -1.232 -0.75 -1.237 -1.006 -0.011 -0.537 0.72 -0.515 1.066 -0.515 1.777 0 3.125 1.891 3.75 2.869 1.55 2.414 3.213 2.819 4.07 2.819 1.066 0 1.987 -0.16 2.622 -0.466 0.293 -2.065 1.212 -3.905 2.71 -5.222 -6.669 -1.333 -11.375 -5.158 -11.375 -11.375 0 -3.203 1.285 -6.146 3.427 -8.522 -0.219 -0.62 -0.583 -1.875 -0.583 -3.919 0 -1.351 0.094 -3.009 0.711 -4.621 0 0 4.056 0.028 7.88 3.651C31.138 21.074 33.027 20.781 35 20.781s3.862 0.293 5.627 0.807c3.825 -3.622 7.88 -3.651 7.88 -3.651 0.62 1.612 0.711 3.27 0.711 4.621 0 2.204 -0.293 3.489 -0.472 4.044C50.822 28.957 52.063 31.854 52.063 35c0 6.217 -4.706 10.042 -11.375 11.375 1.781 1.564 2.844 3.842 2.844 6.398v9.359c-0.63 0.198 -1.271 0.37 -1.92 0.524C54.127 59.675 63.438 48.428 63.438 35 63.438 19.295 50.705 6.563 35 6.563zm1.983 56.798zm4.345 -0.639zM35 63.438zm-2.419 -0.109z'></path>
    </svg>
  ),
};
